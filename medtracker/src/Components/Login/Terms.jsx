    ...
    <div className="bg-blue-100 w-[100%] h-[100%] ">
      ...
      <div className="overflow-y-auto w-[600px] h-[600px] mx-auto mb-6 flex flex-col bg-white rounded-l-3xl">
        ...
        <div>
          ...
          <div className="overflow-y-auto w-[500px] h-[500px] mx-auto mb-6 flex flex-col bg-white rounded-l-3xl">
            <div className="pl-2 pt-2">
              <p className="text-gray-400">
                Terms & Conditions <br />
                Updated at 2022-01-01 <br />
                <br />
                General Terms
                <br />
                ...
                communication between you and World Medical Card.
                <br />
                <br />
                ...
                repair or correction o f equipment or data, you assume any costs
                thereof.
                <br />
                <br />
                World Medical Card will not be responsible for any outcome that
                ...
                will provide to you at the time of such use or purchase. <br />
                <br />
                Updates to Our Terms <br />
                ...
                use of the material is prohibited. <br />
                <br />
                ...
                possible meaning allowable under law. <br />
                <br />
                Notice of Dispute <br />
                ...
                address if we have it, or otherwise to your email address. You
                and us will attempt to resolve any dispute through informal
                ...
                whether express or implied. We are a distributor and not a
                ...
                provided through or accessible via our Service. Without limiting
                the foregoing, We specifically disclaim all warranties and
                ...
                <ul className="list-disc">
                  <li>Via Email: post@wmc-card.no</li>
                  <li>Via Phone Number: +47 55 33 75 75</li>
                </ul>
              </p>
            </div>
          </div>
