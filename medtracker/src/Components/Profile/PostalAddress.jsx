...
function PostalAddress() {
  return (
    <div data-testid="postal" className="flex-1 ml-6">
      ...
      />
      <h1 className="font-medium ml-2">Insurance</h1>
      <p className="font-light m-2">Add insurance inforamtion</p>
      <select
        name="insurance"
        id="insurance"
        className="flex-2 rounded border-black p-2 m-3 w-full border focus:outline-none bg-white focus:border-sky-500"
      >
      ...
      <input
        type="text"
        className="flex-2 rounded border-black p-2 m-2 w-full border focus:outline-none focus:border-sky-500"
        placeholder="Emergence telephone(optional)"
      />
    </div>
  );
}
