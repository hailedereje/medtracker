...
function PersonalInfo() {
  return (
    <div data-testid="personal" className="flex-1">
      <h1 className="text-[#263238] mt-2">Personal Info </h1>
      <p className="text-[#718096] my-2">
      ...
      <form>
        ...
        <label htmlFor="donate" className="ml-2">
